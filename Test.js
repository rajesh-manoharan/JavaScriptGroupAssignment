...
// // for (let i = 0 ; i < Object.keys(resumeJson.resume).length;i++) {
// // 	console.log(Object.values(resumeJson.resume[i]));

// // }

// const iterate = (resumeJson) => {
// 	const stack = [obj];
...
// // console.log(resumeJson.resume[1]);
// // console.log(resumeJson.resume[2]);
// // console.log(resumeJson.resume[3]);
// // console.log(resumeJson.resume[4]);
// // console.log(resumeJson.resume[5]);
// // console.log(resumeJson.resume[6]);

// // resumeArray.map((resume) => {
// //     const resumeObject = resume[0];
// //     console.log(resumeObject);
// // } )

// // const resumeObject = resumeJson.resume[1];
// // console.log(resumeObject);
// // console.log(resumeObject.id);

// console.log(Object.keys(resumeJson.resume[0].basics.name).type);

// console.log(resumeJson.resume[0].basics.name
// console.log(Object.values(resumeJson.resume[0].basics.name));
...
function process(key, value) {
	if (value !== null){
		...
		workObject.appendChild(element);
	}
...
// traverse(resumeJson, process);

const getEmployeeDetails = (resumeJson, objectForDetail) => {
	// for (let i = 0; i < Object.keys(resumeJson.resume).length; i++) {
		let i = 0;
		console.log('-----------------Employee------------------------', i);
		// const { id, basics, skills, work, Internship,projects,education } = resumeJson.resume[i];
		const work = getValue(objectForDetail, resumeJson.resume[3])
		traverse(work, process)
	// }
}

const workObject = document.getElementById("education");
console.log(workObject);
getEmployeeDetails(resumeJson,'education');
